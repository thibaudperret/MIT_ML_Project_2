...
def main(argv=None):  # pylint: disable=unused-argument
    ...
    def get_prediction_with_groundtruth_only(filename, image_idx):
    ...
    with tf.Session() as s:
        ...
        for i in range(1, TRAINING_SIZE+1):
            ...
            Image.fromarray(pimg).convert('RGB').save(prediction_training_dir + "prediction_" + str(i) + ".png")
            oimg = get_prediction_with_overlay(train_data_filename, i)
            oimg.save(prediction_training_dir + "overlay_" + str(i) + ".png")
            onlyGroundTruthimg = get_prediction_with_groundtruth_only(train_data_filename, i)
            Image.fromarray(onlyGroundTruthimg).convert('RGB').save(prediction_training_dir + "prediction2_" + str(i) + ".png")
